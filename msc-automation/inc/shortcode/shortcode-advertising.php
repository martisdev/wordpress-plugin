        ...
        if(isset($_POST['falca']) || isset($_POST['cliID'])){
                ...
                if(isset($_POST['CliUser']) || isset($_POST['CliPsw'])  ){
                        ...
                        if (!$CliUsusari || !$CliPassword){                                        
                            ...
                            //$info_client = $Publicitat->validar_client($CliUsusari,$CliPassword,$MyRadio->CLIENT_SECRET_KEY);
                            global $MyRadio;                
                            if(!isset($MyRadio)){ 
                            ...
                            if ( $info_client > 0){
                                ...
                                $CliId = $info_client['CLI_ID'][0];
                                $Empresa = $info_client['CLI_EMPRESA'][0];
                                $Titular = $info_client['CLI_TITULAR'][0];
                                ...
                                $falques = $Publicitat->get_llista_falques_client($CliId,$total_rows);
                                if ( $total_rows > 0){
                                        // S'han d'escollir totes o una de les falques.
