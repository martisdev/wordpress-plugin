...
$strReturn .= '<div class="artist"><span>' . sanitize_text_field($list['track']['INTERP']) . '</span></div>';
$strReturn .= '<div >' . sanitize_text_field($list['track']['TITLE']) . '</div>';
$strReturn .= '</div>';
