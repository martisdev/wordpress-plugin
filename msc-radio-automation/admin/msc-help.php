<div class="wrap">
    ...
    <p><?php _e('To give functionality to your website you just have to enter shortcodes in the pages. You can go to the section \'initialize\' and generate all the basic pages automatically and then modify the ones you want to customize', 'mscra-automation');?>
    </p>
    <p><?php _e('You also have a shortcode widget now_playing available. You\'ll find it in the widgets section', 'mscra-automation');?>
    </p>
    ...
    <dd>
        <ul>
            ...
            <p><?php _e('Section for customers where they can check the radiation of their advertising', 'mscra-automation')?>
            </p>
    ...
    <dd>
        <ul>
            ...
            <h2>mscra_home</h2>
            <p><?php _e('Shows the shortcodes now_onair and player_streaming at the same time', 'mscra-automation')?>
            </p>
    ...
    <dd>
        <ul>
            ...
            <dl>
                ...
                <dd>
                    <ul>
                        <li>rows="10" (<?php _e('optional', 'mscra-automation');?>):
                            <?php _e('Number of records to show. By default 10', 'mscra-automation');?></li>
                        <li>refresh="false" (<?php _e('optional', 'mscra-automation');?>):
                            <?php _e('Auto refresh the table, by default false', 'mscra-automation');?></li>
                        <li>image="false" (<?php _e('optional', 'mscra-automation');?>):
                            <?php _e('Show image if exist', 'mscra-automation');?></li>
                        <li>stylebutton="" (<?php _e('optional', 'mscra-automation');?>):
                            <?php _e('button class', 'mscra-automation');?></li>
                    </ul>
                </dd>
            </dl>
            <p><?php _e('Example', 'mscra-automation')?>: <input type='text'
                    value='[mscra_last_played rows="25" refresh="true" image="false" stylebutton="mybuttonclass"]'
                    size="50"> </p>
            ...
            <dl>
                ...
                <dd>
                    <ul>
                        <li>image="false" (<?php _e('optional', 'mscra-automation');?>):
                            <?php _e('Show image if exist', 'mscra-automation');?></li>
                        <li>img_width="false" (<?php _e('optional', 'mscra-automation');?>):
                            <?php _e('Width of the image in pixels. By default 200', 'mscra-automation');?></li>
                    </ul>
                </dd>
            </dl>
            ...
            <p><?php _e('Form in which the public can choose the following song given several options', 'mscra-automation')?>
            </p>
            <dl>
                <dt><strong><?php _e('Params', 'mscra-automation')?></strong></dt>
                <dd>
            ...
            <dl>
                ...
                <dd>
                    <ul>
                        <li>rows="5" (<?php _e('optional', 'mscra-automation');?>):
                            <?php _e('Number of records to show. By default 5', 'mscra-automation');?></li>
                    </ul>
                </dd>
            </dl>
            ...
            <p><?php _e('Shows information about a song', 'mscra-automation')?></p>
            <dl>
                <dt><strong><?php _e('Params', 'mscra-automation')?></strong></dt>
                <dd>
                    <ul>
            ...
            <dl>
                ...
                <dd>
                    <ul>
                        ...
                        <li>download="false" (<?php _e('optional', 'mscra-automation');?>):
                            <?php _e('Downloadable programs. by default false', 'mscra-automation');?></li>
                    </ul>
                </dd>
            </dl>
            <p><?php _e('Example', 'mscra-automation');?>: <input type='text'
                    value='[mscra_show_program prg="1" download="true"]' size='50'></p>

            <h2>mscra_list_programs</h2>
            <p><?php _e('Shows a list of programs with image and link', 'mscra-automation')?></p>
            <p><?php _e('Example', 'mscra-automation');?>: <input type='text' value='[mscra_list_programs]' size='50'>
            </p>
        </ul>
    </dd>
